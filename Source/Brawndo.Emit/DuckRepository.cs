...
namespace Brawndo.Emit
{
	public static class DuckRepository
	{
		...
		public static object CreateDuck(Type duckType, IEnumerable<Tuple<string, Type, object>> properties)
		{
		...
		public static Type GenerateDuckType(string typeId)
		{
			Type type;
		...
		public static Type GenerateDuckType(IEnumerable<Tuple<string, Type>> properties)
		{
		...
		public static Type GenerateDuckType(string typeId, IEnumerable<Tuple<string, Type>> properties)
		{
			Type type;
